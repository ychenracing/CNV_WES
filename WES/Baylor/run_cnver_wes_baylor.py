...
'''
samples_path = '/stornext/snfs5/ruichen/dmhg/fgi/wangfei/wes_samples/case'
output_folder = '/stornext/snfs5/ruichen/dmhg/fgi/lily/CNV/CNVer/ychen/wes'
samplelist_path = os.path.join(output_folder, 'sample_list')


def run_cnver():
    command = '/stornext/snfs5/ruichen/dmhg/fgi/lily/software/cnver-0.8.1/src/cnver.pl --map_list ' + samplelist_path + ' --ref_folder /stornext/snfs5/ruichen/dmhg/fgi/lily/software/cnver-0.8.1/hg19comp --work_dir ' + output_folder + ' --read_len 100 --mean_insert 300 --stdev_insert 70 --min_mps 2'
...
if __name__ == '__main__':
    with open(samplelist_path, 'w+') as fw:
        ...
        for fileitem in files:
            if 'mapped' in fileitem and fileitem.endswith('bam'):
